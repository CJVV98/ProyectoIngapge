...
/**
 * CLase encargada de analizar los resultados de las pruebas saber Quinto
 * @author Corin Viracacha
 */
@ManagedBean(name = "saberQuinto")
@ViewScoped
public class SaberQuinto implements Serializable {
    private static final String SABER = "saber5";  
    ...
    /**
     * Metodo para validar el año seleccionado
     * @param e evento del menu desplegable de año
     */
     ...
     * @param e evento del año seleccionado
     */
     ...
     * @param e metodo del año seleccionado en la grafica radar
     */
    ...
    /**
     * Metodo para cargar el dialogo de auto-ayuda
     */
    ...
    public void generarReporte(){
        ...
        reporte.setTituloInicial("QUINTO");
